...
class Transformer2DModel(ModelMixin, ConfigMixin):
    ...
    def forward(self, hidden_states, encoder_hidden_states=None, timestep=None, attn_map=None, attn_shift=False, obj_ids=None, relationship=None, return_dict: bool = True):
        ...
        # 2. Blocks
        for block in self.transformer_blocks:
            hidden_states, cross_attn_prob, self_attn_prob = block(hidden_states, context=encoder_hidden_states, timestep=timestep)
        # 3. Output
        if self.is_input_continuous:
...
class BasicTransformerBlock(nn.Module):
    ...
    def forward(self, hidden_states, context=None, timestep=None):
        ...
        tmp_hidden_states, self_attn_prob = self.attn1(norm_hidden_states)
        # print(cross_attn_prob.shape)
